   ...
   <div>
      ...
      <#if authenticated>
       <script type="text/javascript">
         if (typeof window.opener.window.Alfresco.GoogleGlass == "object" && typeof window.opener.window.Alfresco.GoogleGlass.onOAuthReturn != "undefined")
         {
            window.opener.window.Alfresco.GoogleGlass.onOAuthReturn(true);
            self.close();
         }
